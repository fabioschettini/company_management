    ...
    <div class="header_resize">
      ...
      <div class="menu_nav">
        <ul>
          ...
          <!--  <li><a href="/company_management/CompanyManagementServlet?whatsend=listEmployee" target="_top" ><span>Employees List</span></a></li>-->   
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar"><div class="submb">
       <div class="article">
          <h2>Benvenuto</h2>
          <p> in questa applicazione in cui potrai gestire imprese e relativi impiegati.</p>
        </div>
        </div>
      </div>
      <div class="clr"></div>
